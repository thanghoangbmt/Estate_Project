...
public class AdminInsertEstateController extends HttpServlet {

    private final String SUCCESS = "AdminSearchEstateController";
    private final String ERROR = "admin_insert_estate.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PropertyDTO proDTO = new PropertyDTO(address, salePrice, square, interior, description, numberOfRoom, numberOfToilet, sold, images, category, province, owner);
            PropertyDAO proDAO = new PropertyDAO();
            boolean result = proDAO.insertNewProperty(proDTO);
            ...
            log("Error at AdminInsertEstateController: " + e.toString());
        } finally {
