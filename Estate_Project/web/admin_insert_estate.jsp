...
<html>
    <head>
        ...
        <title>Admin Insert Estate Page</title>
    </head>
    <body>
        ...
        <div class="container" style="padding-top: 150px;">
            <form action="MainController" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width: 25%">
                    ...
                    <input type="number" class="form-control" name="price" id="price" placeholder="Enter price" required="true">
                </div>

                <div class="form-group" style="width: 25%">
                    <label for="square">Square</label>
                    <input type="number" class="form-control" name="square" id="square" placeholder="Enter square" required="true">
                </div>
                ...
                <div class="form-group" style="width: 25%">
                    ...
                    <input type="number" class="form-control" name="numberOfRoom" id="numberOfRoom" placeholder="Enter number of room" required="true" min="0">
                </div>

                <div class="form-group" style="width: 25%">
                    <label for="numberOfToilet">Number Of Toilet</label>
                    <input type="number" class="form-control" name="numberOfToilet" id="numberOfToilet" placeholder="Enter number of toilet" required="true" min="0">
                </div>
                ...
                <div class="form-group" style="width: 25%">
                    ...
                    <input type="text" class="form-control" name="owner" id="owner" placeholder="Enter Owner" required="true">
                </div>
                ...
                <button class="btn btn-success" name="action" value="Admin_Insert_Estate">Insert Estate</button>
