                        ...
                        <div class="blog-sidebar-area">
                            <form action="MainController" method="POST">
                                <div class="form-group mb-15">
                                    ...
                                    <input type="hidden" name="propertyID" value="${requestScope.PROPERTY_DETAILS.propertyID}"/>
                                    <input type="hidden" name="address" value="${requestScope.PROPERTY_DETAILS.address}"/>
                                    <input type="hidden" name="salePrice" value="${requestScope.PROPERTY_DETAILS.salePrice}"/>
                                    <input type="hidden" name="square" value="${requestScope.PROPERTY_DETAILS.square}"/>
                                    <input type="hidden" name="interior" value="${requestScope.PROPERTY_DETAILS.interior}"/>
                                    <input type="hidden" name="description" value="${requestScope.PROPERTY_DETAILS.description}"/>
                                    <input type="hidden" name="numberOfRoom" value="${requestScope.PROPERTY_DETAILS.numberOfRoom}"/>
                                    <input type="hidden" name="numberOfToilet" value="${requestScope.PROPERTY_DETAILS.numberOfToilet}"/>
                                    <input type="hidden" name="sold" value="${requestScope.PROPERTY_DETAILS.sold}"/>
                                    <input type="hidden" name="category" value="${requestScope.PROPERTY_DETAILS.category}"/>
                                    <input type="hidden" name="province" value="${requestScope.PROPERTY_DETAILS.province}"/>
                                    <input type="hidden" name="owner" value="${requestScope.PROPERTY_DETAILS.owner}"/>
                                </div>
